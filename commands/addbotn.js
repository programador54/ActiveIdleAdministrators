							...
							let cl = message.channel
								...
								.on('collect', async d => {
									...
									let falha4 = new Discord.MessageEmbed()
										.setTitle(
											'<a:Desligado:772083231528976385> | Uso Incorreto!'
										)
										.setTimestamp()
										.setThumbnail(
																					...
																					.then(collected => {
																						...
																						if (reaction.emoji.name === '✅') {
																							...
																							embed5.setDescription(
																								`Bot enviado para a verificação com sucesso ${don} fique atento no canal <#773831154989531166> por lá você saberá se o bot foi aprovado ou reprovado!`
																							);
																							embed5.setThumbnail(
