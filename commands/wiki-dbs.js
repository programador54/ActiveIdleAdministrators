...
module.exports = {
  ...
  //!say Hi!
  //Hi
const channel = client.channels.cache.find(channel => channel.id === '780423006698078218')
...
if(!botmessage) return message.channel.send(`<a:Ve_ErradoTKF:754787728104620182> | Você não informou nenhum texto para ser enviado ${message.author}!`).then(msg => msg.delete({timeout: 5000}));
 ...
 .setThumbnail(message.author.displayAvatarURL({dynamic: true}))
  ...
  embed2.setDescription(`Olá ${message.author}, Sua wiki foi enviada no canal <#780423006698078218> com sucesso!`)
